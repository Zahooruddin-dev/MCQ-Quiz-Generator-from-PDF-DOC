	...
	return (
		<div className='upload-container' aria-live='polite'>
			...
			{hasAI && (
				<div className='ai-config-panel' aria-hidden={effectiveLoading}>
					...
					<div className='ai-toggle'>
						<label
							className='switch'
							title='Enable/disable AI question generation'
						>
							<input
								type='checkbox'
								checked={useAI}
					...
					<div style={{ marginTop: 12, display: 'flex', gap: 8 }}>
						...
						<button
							onClick={() => {
								...
								if (!useAI) {
									setError(
										'Enable "Use AI Generation" to generate from text samples.'
									);
									return;
								}
			...
			<div
				...
				onDrop={handleDrop}
				onClick={() =>
					!effectiveLoading && document.getElementById('file-input')?.click()
				}
			...
			>
				{effectiveLoading ? (
					...
					<div className='upload-content'>
						...
						<h3>
							{fileName ? `Selected: ${fileName}` : 'Upload Your Document'}
						</h3>
			...
			>
				...
				<button
					...
					onClick={() => {
						...
						if (!useAI) {
							setError(
								'Enable AI or paste text to generate questions from content.'
							);
							return;
						}
