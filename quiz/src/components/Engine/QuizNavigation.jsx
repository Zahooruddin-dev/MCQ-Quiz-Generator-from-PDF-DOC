  ...
  return (
    <Box sx={{ 
      ...
      <Box sx={{ mb: 4, textAlign: 'center' }}>
        ...
        >
          {userAnswers.map((_, index) => {
            const isVisible = totalQuestions <= 15 || // Show all if 15 or fewer
            ...
            if (!isVisible && index !== currentQuestion - 4 && index !== currentQuestion + 4) {
              return null;
            }
            ...
            return (
              <Tooltip
                key={index}
                title={`Question ${index + 1}${userAnswers[index] !== null ? ' - Answered' : ''}`}
                arrow
              >
                <IconButton
                  size="small"
                  ...
                  sx={{
                    ...
                    bgcolor: index === currentQuestion
                      ...
                      ? 'success.main'
                      : 'transparent',
                    color: index === currentQuestion || userAnswers[index] !== null
                      ? 'white'
                      : 'text.primary',
                    border: '2px solid',
                    borderColor: index === currentQuestion
