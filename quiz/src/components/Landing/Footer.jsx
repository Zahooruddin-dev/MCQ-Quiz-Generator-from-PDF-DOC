        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={6}>
            <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
              ...
              <Typography variant="h6" sx={{ fontWeight: 800 }}>QuizAI</Typography>
            </Box>
          ...
          {/* Footer Links */}
          <Grid item xs={6} md={2}>
            <Typography variant="body2" sx={{ fontWeight: 600, mb: 2 }}>Product</Typography>
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
              ...
              <Typography variant="body2" sx={{ color: 'text.secondary' }}>Use Cases</Typography>
            </Box>
          </Grid>

          <Grid item xs={6} md={2}>
            <Typography variant="body2" sx={{ fontWeight: 600, mb: 2 }}>Resources</Typography>
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
              <Typography variant="body2" sx={{ color: 'text.secondary' }}>Blog</Typography>
              <Typography variant="body2" sx={{ color: 'text.secondary' }}>Documentation</Typography>
              <Typography variant="body2" sx={{ color: 'text.secondary' }}>Support</Typography>
            </Box>
          </Grid>

          <Grid item xs={6} md={2}>
            <Typography variant="body2" sx={{ fontWeight: 600, mb: 2 }}>Company</Typography>
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
